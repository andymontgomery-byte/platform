...
python3 -m py_compile scripts/generate_spec_dictionaries.py scripts/generate_oneroster_core.py scripts/generate_qti_core.py scripts/generate_case_core.py scripts/generate_caliper_core.py scripts/generate_integration_governance_core.py scripts/build_static_api.py scripts/build_site_docs.py scripts/check_dictionary_artifacts.py scripts/check_spec_conformance.py scripts/check_supabase_rest.py scripts/snapshot_pg_policies.py scripts/codex_loop.py tests/supabase_tenant_rls_test.py tests/supabase_audit_log_test.py
