...
Items 1 through 7 are now cleared for the structured OneRoster, QTI, and CASE dictionaries. The next cheapest high-leverage work is wiring CASE into `scripts/check_dictionary_artifacts.py`, then item 8: convert Caliper to a structured source dictionary and generated artifacts.
