...
insert into public.organizations (
  id, sourced_id, name, organization_type, parent_organization_id, status, date_last_modified
) values
...
insert into public.people (
  id, sourced_id, display_name, given_name, family_name, email, primary_role, enabled_user, status, date_last_modified
) values
...
insert into public.academic_sessions (
  id, sourced_id, title, session_type, start_date, end_date, school_year, status, date_last_modified
) values
...
insert into public.courses (
  id, sourced_id, title, course_code, org_id, school_year_id, status, date_last_modified
) values
...
insert into public.classes (
  id, sourced_id, title, class_type, class_code, course_id, school_id, term_id, status, date_last_modified
) values
...
insert into public.enrollments (
  id, sourced_id, class_id, person_id, school_id, role, begin_date, end_date, primary_flag, status, date_last_modified
) values
...
insert into public.line_items (
  id, sourced_id, title, class_id, category, assign_date, due_date, result_value_min, result_value_max, status, date_last_modified
) values
...
insert into public.results (
  id, sourced_id, line_item_id, person_id, score_status, score, score_date, comment, status, date_last_modified
) values
...
insert into public.source_identifiers (
  id, object_type, object_id, source_system, external_id, identifier_type, status
) values
